...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("The row was inserted correctly", weatherRowId != -1);
        ...
        assertTrue("No rows found when we moved to first row", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("The record didn't match the record we inserted", cursor,
            contentValues);
        assertFalse("The cursor didnt fetch any more record", cursor.moveToNext());
    ...
    public long insertLocation() {
        ...
        //String whereClause = "WeatherContract.LocationEntry._ID = ?";
        //String[] whereArgs = new String[] {locationRowId.toString()};
